...
// Crea los datos que necesites para hacer las pruebas. Debes incluir en tu programa funciones flecha.
...
class Banda {
    ...
    imprimirListadoBandas(){
        listabanda="La banda "+this.nombre+" está formada por "+this.lista;
    return listabanda;
    }
